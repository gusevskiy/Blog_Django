...
INSTALLED_APPS = [
    ...
    'django.contrib.auth',  # встроенный модуль регистрации авторизации
...
# в таком расположении статика (фавикон) работает
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]

# подключение дириктории со статическими файлами my
